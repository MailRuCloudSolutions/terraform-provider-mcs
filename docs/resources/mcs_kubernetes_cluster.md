...
* `master_flavor` - (Optional) The UUID or name of a flavor for the master nodes. (From v0.5.5 only UUID is supported)</br>
...
* `master_flavor` - The UUID or name of a flavor for the master nodes. (From v0.5.5 only UUID supported)
